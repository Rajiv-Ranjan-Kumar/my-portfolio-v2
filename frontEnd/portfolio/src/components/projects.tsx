...
export default function Projects() {
    ...
    const projects = [
        ...
        },
        {
            ...
            gitHubUrl: "https://github.com/Rajiv-Ranjan-Kumar/apna-restro/tree/main/frontEnd",
                ...
                {projects.map((project:any, index:number) => (
                    <div key={index} className={styles.project} onMouseEnter={()=>handleMouseEnter(index)} onMouseLeave={()=>handleMouseLive()}>
                        ...
                        <div className={styles.imageContainer}>
                            <Image src={project.imageUrl} width={100} height={100} className={styles.img} alt="project image" layout='responsive' />
                        </div>
                        
                        {/* Project name display */}
                        <div className={styles.text}>
                            <span>Project : </span>&nbsp;&nbsp;<h5 id='projectName'>{project.projectsName}</h5>
                        </div>

                        {/* Show project details when hovering over a project */}
                        {indexNumber === index && (
                            <div className={styles.projectDetails}>
                                <div className={styles.projectDetailsUpperContainer}>
